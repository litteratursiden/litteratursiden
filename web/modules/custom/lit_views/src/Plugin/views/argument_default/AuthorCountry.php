...
/**
 * Default argument plugin to extract author country.
 *
...
class AuthorCountry extends ArgumentDefaultPluginBase implements CacheableDependencyInterface {
  ...
  /**
   * Constructs a new AuthorCountry instance.
   *
  ...
  public function getArgument() {
    ...
    $country_field = $node->get('field_author_portrait_country');
    if ($country_field && $country = $country_field->value) {
      return $country;
    }
